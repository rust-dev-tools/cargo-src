...
project's directory (i.e., the directory you would normally use cargo or rustc
from).
...
use to view the code. The terminal is only used to display some logging, it can
be ignored.
...
([issue 48](https://github.com/nrc/rustw/issues/48)).
